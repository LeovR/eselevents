...
var eseleventsApp = angular.module('eseleventsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'eseleventsAppUtils', 'pascalprecht.translate', 'truncate']);
